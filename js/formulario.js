...
document.getElementById('dirNormativa').addEventListener('change', e => {
    ...
    if(e.target.value != 46){
        ...
        Object.values(document.querySelectorAll('.divDirRub')).map(el => {
            ...
            el.setAttribute('attr-hide','');
        });
        document.querySelector('.divOtroDirNorm').classList.add('d-none');
        document.querySelector('.divOtroDirNorm').removeAttribute('attr-hide');
        document.querySelector('.divOtroRubro').classList.add('d-none');
        document.querySelector('.divOtroRubro').removeAttribute('attr-hide');
    }else{
        ...
        Object.values(document.querySelectorAll('.divDirRub')).map(el => {
            ...
            el.removeAttribute('attr-hide');
        });
        document.querySelector('.divOtroDirNorm').classList.remove('d-none');
        document.querySelector('.divOtroDirNorm').setAttribute('attr-hide','');
        document.querySelector('.divOtroRubro').classList.remove('d-none');
        document.querySelector('.divOtroRubro').setAttribute('attr-hide','');
    }
});
...
document.querySelector('.nvo').addEventListener('click', e=> {
    $('#inicial').modal('hide');
    $('#clasificacion').modal('show');
});
...
$("#vigencia").submit(function(event) {
    ...
    fetch('../operacion/core/app/BuscaFolio.php', {
        ...
        .then(data => {
            ...
            let tabla = _createTable(data.response[0]);
...
document.getElementById('form').addEventListener('submit',e => {
	...
	if(document.getElementById('i-accion').value == 1) {
        let newHeight = parseInt(document.getElementById('Paso').style.height) + 50;
        document.getElementById('Paso').style.height = newHeight+'px';
...
function llenaForm(){
    ...
    document.getElementById('LoginId').innerHTML = 'LoginId: '+ datosFolio.LoginId;
    ...
    document.querySelector('.Actualizar').classList.remove('invisible');
