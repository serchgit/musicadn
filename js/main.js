$(document).ready(function () {
    ...
    function escribirSpan(indice, letra) {
        ...
        for (let i = 0; i < lista_span.length; i++) {
            if (i == indice) {
                ...
                $(lista_span[i]).addClass('letraDes');
            }
        }
    }
    ...
    function gane() {
        ...
        $('#etiqueta_mensaje').html('Felicidades !').removeClass('text-danger').addClass('text-success');
        $('#cuerpo_mensaje').html('<h2 class="bg-success text-white mb-2">Texto Acertado</h2><img src="img/aplausos.gif" class="img-fluid rounded">');
        $('#mensaje').modal('show')
        mostrarPalabra('gane');
    }
    ...
    function perdida() {
        ...
        $('#etiqueta_mensaje').html('Lo siento!').addClass('text-danger').removeClass('text-success');
        $('#cuerpo_mensaje').html('<h2 class="bg-danger text-white mb-2">Texto Perdido</h2><img src="img/triste.gif" class="img-fluid rounded">');
        $('#mensaje').modal('show')
    }
    ...
    function iniciarbutton(input) {
        let input_palabra_secreta = $('#'+input+'');
    ...
    main();
$(".botones button").click(function(event) {
    let input = $(this).children('input').attr("id");
    let ancho = $(this).attr("data-ancho");
    console.log(input)
    $(this).attr("disabled","disabled")
    inicializar()
    iniciarbutton(input);
    $("#palabra").css("width",ancho+"rem")
});
